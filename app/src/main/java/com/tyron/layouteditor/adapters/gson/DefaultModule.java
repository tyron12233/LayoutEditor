 ...
 * @author adityasharat
 */
public class DefaultModule implements EditorTypeAdapterFactory.Module {
  ...
  public final CustomValueTypeAdapterCreator<AttributeResource> ATTRIBUTE_RESOURCE = new CustomValueTypeAdapterCreator<AttributeResource>() {
    @Override
    public CustomValueTypeAdapter<AttributeResource> create(int type, EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<Binding> BINDING = new CustomValueTypeAdapterCreator<Binding>() {
    @Override
    public CustomValueTypeAdapter<Binding> create(int type, final EditorTypeAdapterFactory factory) {
      return new CustomValueTypeAdapter<Binding>(type) {
        ...
        public Binding read(JsonReader in) throws IOException {
          return Binding.valueOf(in.nextString(), factory.getContext(), EditorTypeAdapterFactory.EDITOR_INSTANCE_HOLDER.getEditor().functions);
        }
      };
    }
  };
  ...
  public final CustomValueTypeAdapterCreator<Color.Int> COLOR_INT = new CustomValueTypeAdapterCreator<Color.Int>() {
    @Override
    public CustomValueTypeAdapter<Color.Int> create(int type, EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<Color.StateList> COLOR_STATE_LIST = new CustomValueTypeAdapterCreator<Color.StateList>() {
    @Override
    public CustomValueTypeAdapter<Color.StateList> create(int type, EditorTypeAdapterFactory factory) {
      return new CustomValueTypeAdapter<Color.StateList>(type) {
        ...
        public void write(JsonWriter out, Color.StateList value) throws IOException {
          ...
          out.name(KEY_STATES);
          out.value(EditorTypeAdapterFactory.writeArrayOfIntArrays(value.states));

          out.name(KEY_COLORS);
          out.value(EditorTypeAdapterFactory.writeArrayOfInts(value.colors));
        ...
        public Color.StateList read(JsonReader in) throws IOException {
          ...
          in.nextName();
          int[][] states = EditorTypeAdapterFactory.readArrayOfIntArrays(in.nextString());

          in.nextName();
          int colors[] = EditorTypeAdapterFactory.readArrayOfInts(in.nextString());
  ...
  public final CustomValueTypeAdapterCreator<Dimension> DIMENSION = new CustomValueTypeAdapterCreator<Dimension>() {
    @Override
    public CustomValueTypeAdapter<Dimension> create(int type, EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<DrawableValue.ColorValue> DRAWABLE_COLOR = new CustomValueTypeAdapterCreator<DrawableValue.ColorValue>() {
    @Override
    public CustomValueTypeAdapter<DrawableValue.ColorValue> create(int type, final EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<DrawableValue.LayerListValue> DRAWABLE_LAYER_LIST = new CustomValueTypeAdapterCreator<DrawableValue.LayerListValue>() {
    @Override
    public CustomValueTypeAdapter<DrawableValue.LayerListValue> create(int type, final EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<DrawableValue.LevelListValue> DRAWABLE_LEVEL_LIST = new CustomValueTypeAdapterCreator<DrawableValue.LevelListValue>() {
    @Override
    public CustomValueTypeAdapter<DrawableValue.LevelListValue> create(int type, final EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<DrawableValue.ShapeValue> DRAWABLE_SHAPE = new CustomValueTypeAdapterCreator<DrawableValue.ShapeValue>() {
    @Override
    public CustomValueTypeAdapter<DrawableValue.ShapeValue> create(int type, final EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<DrawableValue.RippleValue> DRAWABLE_RIPPLE = new CustomValueTypeAdapterCreator<DrawableValue.RippleValue>() {
    @Override
    public CustomValueTypeAdapter<DrawableValue.RippleValue> create(int type, final EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<DrawableValue.StateListValue> DRAWABLE_STATE_LIST = new CustomValueTypeAdapterCreator<DrawableValue.StateListValue>() {
    @Override
    public CustomValueTypeAdapter<DrawableValue.StateListValue> create(int type, final EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<DrawableValue.UrlValue> DRAWABLE_URL = new CustomValueTypeAdapterCreator<DrawableValue.UrlValue>() {
    @Override
    public CustomValueTypeAdapter<DrawableValue.UrlValue> create(int type, EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<Layout> LAYOUT = new CustomValueTypeAdapterCreator<Layout>() {
    @Override
    public CustomValueTypeAdapter<Layout> create(int type, final EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<NestedBinding> NESTED_BINDING = new CustomValueTypeAdapterCreator<NestedBinding>() {
    @Override
    public CustomValueTypeAdapter<NestedBinding> create(int type, final EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<Resource> RESOURCE = new CustomValueTypeAdapterCreator<Resource>() {
    @Override
    public CustomValueTypeAdapter<Resource> create(int type, EditorTypeAdapterFactory factory) {
  ...
  public final CustomValueTypeAdapterCreator<StyleResource> STYLE_RESOURCE = new CustomValueTypeAdapterCreator<StyleResource>() {
    @Override
    public CustomValueTypeAdapter<StyleResource> create(int type, EditorTypeAdapterFactory factory) {
  ...
  @Override
  public void register(EditorTypeAdapterFactory factory) {
