...
public abstract class ViewTypeParser<V extends View> {
     ...
     */
    @NonNull
    public abstract BaseWidget createView(@NonNull EditorContext context, @NonNull Layout layout,
     ...
     */
    @NonNull
    public BaseWidget.Manager createViewManager(@NonNull EditorContext context, @NonNull BaseWidget view,
        ...
        if (null != this.parent && caller != this.parent) {
            ...
            return new com.tyron.layouteditor.managers.ViewManager(context, caller != null ? caller : this, view.getAsView(), layout, dataContext);
        }
    }
     ...
     */
    @NonNull
    protected DataContext createDataContext(EditorContext context, @NonNull Layout layout, @NonNull ObjectValue data,
                                            @Nullable ViewGroup parent, int dataIndex) {
        DataContext dataContext, parentDataContext = null;
        Map<String, Value> map = layout.data;

        if (parent instanceof BaseWidget) {
            parentDataContext = ((BaseWidget) parent).getViewManager().getDataContext();
        }
     ...
     * @param dataIndex
     */
    public void onAfterCreateView(@NonNull BaseWidget view, @Nullable ViewGroup parent, int dataIndex) {
