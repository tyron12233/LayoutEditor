...
import com.tyron.layouteditor.toolbox.SimpleArrayIterator;
...
public abstract class DrawableValue extends Value {
    ...
    public static class LevelListValue extends DrawableValue {
        ...
        public static class Level {
            ...
            public void apply(BaseWidget view, final LevelListDrawable levelListDrawable) {
    ...
    private static abstract class DrawableElement extends Value {
        ...
        public abstract void apply(BaseWidget view, GradientDrawable drawable);
    ...
    public static class Gradient extends DrawableElement {
        ...
        @Override
        public void apply(BaseWidget view, final GradientDrawable drawable) {
        ...
        public GradientDrawable init(BaseWidget view) {
            int[] colors;
            if (centerColor != null) {
                colors = new int[3];
    ...
    public static class Corners extends DrawableElement {
        ...
        @Override
        public void apply(BaseWidget view, GradientDrawable gradientDrawable) {
            if (null != radius) {
    ...
    public static class Solid extends DrawableElement {
        ...
        @Override
        public void apply(BaseWidget view, final GradientDrawable gradientDrawable) {
            Color.Result result = ColorResourceProcessor.evaluate(color, view);
    ...
    public abstract static class AsyncCallback {
        ...
        public void setBitmap(@NonNull Bitmap bitmap) {
            if (recycled) {
                throw new InflateException("Cannot make calls to a recycled instance!");
            }
            apply(bitmap);
            recycled = true;
        }
